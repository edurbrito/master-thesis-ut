...
% OpenWRT choice vs Raspbian, etc.
% OpenWRT automated build, packages, batman-adv kernel module load, setup, subnetting, geth setup, etc.
% Image generation
...
% Description of the network topology, including the number of nodes, witnesses, prover, etc.
...
\subsection{Results} \label{sec:proof-of-concept-results}
