...
% \begin{figure}[h!]
%     \begin{center}
%     \includegraphics[width=0.5\textwidth]{overview-pol-rel-dg.pdf}
%     \caption{Sequence diagram overview of the proof generation process.}
%     \label{fig:proof-of-location-overview-relative-pol-dg}
%     \end{center}
% \end{figure}
...
\begin{figure}[hb!]
    \begin{center}
    \includegraphics[width=0.9\textwidth]{overview-pol-rel-seq.pdf}
    \caption{Sequence diagram overview of the proof generation process.}
...
\TODO{Missing scenario to connect the protocol}
