...
\TODO{Should these sections have diagrams/figures...? For example, explaining a particular protocol for each section? YES}

\TODO{Should I latex-italic-emph the entities, like \emph{verifier}, \emph{location manager}...? Never, only in the first mention, always..? FIRST MENTION}

\TODO{How to do back references smoothly? Like, I want to mention subsubsection 2.1.4, should I go that deep in the numbering, or Section 2.1 is enough? GO DEEP INTO LEVEL 2, NOT MORE}